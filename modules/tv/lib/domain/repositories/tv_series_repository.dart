...
abstract class TvSeriesRepository {
  ...
  // Local
  Future<Either<Failure, String>> saveTvSeriesWatchlist({required TvSeriesDetail tvSeriesDetail});

  Future<Either<Failure, String>> removeTvSeriesWatchlist({required TvSeriesDetail tvSeriesDetail});
